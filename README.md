# CommonLib
The CommonLib script is a utility script used by many other scripts of mine to provide general functions that are reused frequently.

## Installation
Installing the resource is simple, just download the latest version from the [releases](https://github.com/DevJacob-Studios/DevJacob_CommonLib/releases/latest) tab, place the folder into your FiveM resources folder and then add `ensure DevJacob_CommonLib` to your server.cfg file.
